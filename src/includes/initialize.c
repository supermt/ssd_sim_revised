...
struct ssd_info *initiation(struct ssd_info *ssd, struct configuration *config, unsigned int mcount) {
    ...
    ssd->gc_fg_time = 0;
    ssd->gc_copypage = 0;
    ssd->aged_valid_ratio = 0.5;
    ssd->aged_free_ratio = 0.101;
    ssd->tmp_count = 0;
    ssd->total_gc = 0;
    ssd->min_wear = 999999;
    ...
    //TODO: move this into page_config dir

    strcpy(ssd->parameterfilename, config->parameter);


    strcpy(ssd->tracefilename, config->tracename);
    printf("\ninput trace file name: %s\n", ssd->tracefilename);
    ...
    printf("%s",ssd->parameterfilename);
    ...
    ssd->max_lpn[0] = 14967128064 / ssd->parameter->chip_num;
    ssd->max_lpn[1] = 27310665728 / ssd->parameter->chip_num;
    ssd->max_lpn[2] = 36417159168 / ssd->parameter->chip_num;
    ssd->max_lpn[3] = 509852917248 / ssd->parameter->chip_num;
    ssd->max_lpn[4] = 71214772224 / ssd->parameter->chip_num;
    ssd->max_lpn[5] = 390074384384 / ssd->parameter->chip_num;
    ssd->max_lpn[6] = 17437548544 / ssd->parameter->chip_num;
    ssd->max_lpn[7] = 880861490688 / ssd->parameter->chip_num;
    ssd->max_lpn[8] = 660547898880 / ssd->parameter->chip_num;
    ssd->max_lpn[9] = 236649815552 / ssd->parameter->chip_num;
    ssd->max_lpn[10] = 234744286720 / ssd->parameter->chip_num;
    ssd->max_lpn[11] = 22241177600 / ssd->parameter->chip_num;
    ssd->max_lpn[12] = 18136895488 / ssd->parameter->chip_num;
    ssd->max_lpn[13] = 191520497664 / ssd->parameter->chip_num;
    ssd->max_lpn[14] = 87669419520 / ssd->parameter->chip_num;
    ssd->max_lpn[15] = 8589025280 / ssd->parameter->chip_num;
    ssd->max_lpn[16] = 16778948608 / ssd->parameter->chip_num;
    ssd->max_lpn[17] = 182082108928 / ssd->parameter->chip_num;
    ssd->max_lpn[18] = 182086286848 / ssd->parameter->chip_num;
    ssd->max_lpn[19] = 11583746048 / ssd->parameter->chip_num;
    ssd->max_lpn[20] = 109240061952 / ssd->parameter->chip_num;
    ssd->max_lpn[21] = 23592820736 / ssd->parameter->chip_num;
    ssd->max_lpn[22] = 17077784576 / ssd->parameter->chip_num;
    ssd->max_lpn[23] = 18205724672 / ssd->parameter->chip_num;
    ssd->max_lpn[24] = 36417691648 / ssd->parameter->chip_num;
    ssd->max_lpn[25] = 36411620864 / ssd->parameter->chip_num;
    ssd->max_lpn[26] = 72831761920 / ssd->parameter->chip_num;
    ssd->max_lpn[27] = 182086643200 / ssd->parameter->chip_num;
    ssd->max_lpn[28] = 182084177408 / ssd->parameter->chip_num;
    ssd->tracenumber = mcount;
    return ssd;
}
...
struct dram_info *initialize_dram(struct ssd_info *ssd) {
    ...
    dram->buffer->max_buffer_sector = ssd->parameter->dram_capacity / SECTOR;
...
struct blk_info *initialize_block(struct blk_info *p_block, struct parameter_value *parameter) {
    ...
    p_block->free_page_num = parameter->page_block;
    p_block->last_write_page = -1;
